...
debmirror --method=rsync --root=debian-security --dist=trusty,trusty-updates,trusty-security,trusty-backports,trusty-proposed,xenial,xenial-updates,xenial-security,xenial-backports,xenial-proposed --host=archive.canonical.com --section=partner --arch=i386,amd64 ${MIRRORDIR}/repo/archive.canonical.com/ --getcontents --ignore-release-gpg --progress --i18n --rsync-extra=doc,indices,tools,trace --allow-dist-rename --diff=mirror --slow-cpu     
